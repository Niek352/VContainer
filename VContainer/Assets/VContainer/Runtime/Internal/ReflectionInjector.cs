...
namespace VContainer.Internal
{
    sealed class ReflectionInjector : IInjector
    {
        ...
        public void InjectWithSpan(object instance, IObjectResolver resolver, ReadOnlySpan<IInjectParameter> parameters)
        {
            InjectFields(instance, resolver, parameters);
            InjectProperties(instance, resolver, parameters);
            InjectMethods(instance, resolver, parameters);
        ...
        public object CreateInstanceWithSpan(IObjectResolver resolver, ReadOnlySpan<IInjectParameter> parameters)
        {
            var parameterInfos = injectTypeInfo.InjectConstructor.ParameterInfos;
            var parameterKeys = injectTypeInfo.InjectConstructor.ParameterKeys;
            var parameterValues = CappedArrayPool<object>.Shared8Limit.Rent(parameterInfos.Length);
            try
            {
                ...
                var instance = injectTypeInfo.InjectConstructor.ConstructorInfo.Invoke(parameterValues);
                InjectWithSpan(instance, resolver, parameters);
                return instance;
            }
            catch (VContainerException ex)
            {
        ...
        void InjectFields(object obj, IObjectResolver resolver, ReadOnlySpan<IInjectParameter> parameters)
        {
        ...
        void InjectProperties(object obj, IObjectResolver resolver, ReadOnlySpan<IInjectParameter> parameters)
        {
        ...
        void InjectMethods(object obj, IObjectResolver resolver, ReadOnlySpan<IInjectParameter> parameters)
        {
